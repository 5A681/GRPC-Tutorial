...
var file_calculator_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x28, 0x0a, 0x0e, 0x41,
	...
	0x22, 0x20, 0x0a, 0x10, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63, 0x63, 0x69, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x01, 0x6e, 0x22, 0x2b, 0x0a, 0x11, 0x46, 0x69, 0x62, 0x6f, 0x6e, 0x61, 0x63, 0x63, 0x69, 0x52,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xd0, 0x01, 0x0a, 0x0a, 0x43,
	...
	0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x42, 0x0c, 0x5a,
...
var file_calculator_proto_goTypes = []interface{}{
	(*AverageRequest)(nil),        // 0: services.AverageRequest
	(*AverageResponse)(nil),       // 1: services.AverageResponse
	(*FibonacciRequest)(nil),      // 2: services.FibonacciRequest
	(*FibonacciResponse)(nil),     // 3: services.FibonacciResponse
	(*HelloRequest)(nil),          // 4: services.HelloRequest
	(*HelloResponse)(nil),         // 5: services.HelloResponse
	(*Person)(nil),                // 6: services.Person
	nil,                           // 7: services.Person.ContriesEntry
	(Gender)(0),                   // 8: services.Gender
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
}
var file_calculator_proto_depIdxs = []int32{
	8, // 0: services.Person.gender:type_name -> services.Gender
	7, // 1: services.Person.contries:type_name -> services.Person.ContriesEntry
	9, // 2: services.Person.created_date:type_name -> google.protobuf.Timestamp
	4, // 3: services.Calculator.Hello:input_type -> services.HelloRequest
	2, // 4: services.Calculator.Fibonacci:input_type -> services.FibonacciRequest
	0, // 5: services.Calculator.Average:input_type -> services.AverageRequest
	5, // 6: services.Calculator.Hello:output_type -> services.HelloResponse
	3, // 7: services.Calculator.Fibonacci:output_type -> services.FibonacciResponse
	1, // 8: services.Calculator.Average:output_type -> services.AverageResponse
